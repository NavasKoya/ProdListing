...
class UpdateProductList extends StatefulWidget {
  ...
  const UpdateProductList({Key key, this.productID}) : super(key: key);
...
class _UpdateProductListState extends State<UpdateProductList> {
          ...
          child: Row(
            ...
            children: [
              ...
              InkWell(
                ...
                child: Container(
                  child: _categoryID==''? Text('Select Category') : Text(_categoryName),
                ),
              )
            ],
          ),
      ...
      child: FutureBuilder(
        ...
        builder: (context, _prodSnapshot) {
          if(_prodSnapshot.connectionState == ConnectionState.waiting){
            ...
            _categoryID = _prodListModel.categoryID;
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            color: constCoalBlack,
                            child: _updateImageWidget(_categoryModel, _prodListModel),
                          ),

                          Container(
                            width: _pageSize.width*.3,
                            color: constIvoryColor,
                            child: _updateProductInfoWidget(_prodListModel),
                          ),
  ...
  _blankPageMsg(){
    return Center(
      child: InkWell(
          onTap: _selectCategoryAlertDialog,
          child: Text('Please select category to proceed', style: GoogleFonts.ubuntu(fontWeight: FontWeight.bold),)
      ),
    );
  }
  ...
  _updateProductInfoWidget(ProductListDataModel _prodDataModel) {
    Size _pageSize = MediaQuery.of(context).size;
    ...
    _productImageUrl = _prodDataModel.productImage['img1'];
  ...
  _updateImageWidget(_categoryModel, ProductListDataModel _prodDataModel) {
    Size _pageSize = MediaQuery.of(context).size;
    ...
    return Column(
      ...
      children: [
                ...
                child:  Card(
                  child: Padding(
                    ...
                    child: _productImageFile == null
                        ? Image.network(_prodDataModel.productImage['img1'], fit: BoxFit.cover,)    // Icon(MaterialCommunityIcons.image_plus, size: _pageSize.width*.025,)
        ...
        InkWell(
          onTap: ()=> _updateProdData (_categoryModel),
          child: Card(
            shape: RoundedRectangleBorder(
            ...
            child: Container(
              ...
              child: Text('Update', style: GoogleFonts.ubuntu(fontSize: _pageSize.width*.025, fontWeight: FontWeight.bold),),
            ),
          ),
        )
      ],
  ...
  _updateProdData(CategoryDataModel _categoryModel) async{
    ...
    if(_prodInfoFormKey.currentState.validate()){
      ...
      productsListCollection.doc(widget.productID).update({
        "productName": {
